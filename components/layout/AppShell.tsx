  ...
  return (
    <div className="app-root flex w-full flex-col bg-transparent md:h-dvh md:overflow-hidden">
      ...
      <AppBottomTabBar ariaLabel={home.footerLabel}>
        ...
        <AppBottomTabButton href="https://www.xiaohongshu.com/user/profile/5fa36065000000000101ffa5" external icon={RedbookMark} iconClassName="size-8" label={home.social.redbook} />
        <AppBottomTabButton href="mailto:contact@effortgo.xyz" icon={Mail} label={home.social.email} />
      </AppBottomTabBar>
    </div>
  );
}
